		...
		texto += `
				<div class="container">
					<div class="row">
						...
						<a target="_blank" href="/Trabalho_cinema/detalhes/filme.html?id=${filme.id}">
						...
						<div class="col-lg-6">
							<h4>
								<strong>
									<a target="_blank" class="text-dark" href="/Trabalho_cinema/detalhes/filme.html?id=${filme.id}">
										${filme.title}
										<small class="text-dark"><i class="fa fa-link" aria-hidden="true"></i></small>
									</a>
								</strong>
								<small class="text-dark float-right">
...
function cliqueFilme(idFilme) {
	localStorage.setItem('idFilme', JSON.stringify(idFilme))
	window.location.replace('/Trabalho_cinema/home/filme.html')
  }
